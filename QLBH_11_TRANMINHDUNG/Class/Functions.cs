...
namespace QLBH_11_TRANMINHDUNG.Class
{
    internal class Functions
    {
        ...
        public static void Connect()
        {
           ...
           con = new SqlConnection("Data Source=LAPTOP-8GA3B18K\\SQLEXPRESS;Initial Catalog=QLBH_11_TranMinhDung;User ID=sa; Password = 123456;");
            // Chuỗi kết nối
            con.Open(); // Mở kết nối
            //kiem tra ket noi
        ...
        public static DataTable GetDataToTable(string sql)
        {
            ...
            MyData.Fill(table); //Đổ dữ liệu từ câu lệnh SQL vào bảng table
            return table;
        }
        //Run Sql
        public static void RunSQL(string sql)
        {
            SqlCommand cmd; //Định nghĩa đối tượng thuộc lớp SqlCommand
            cmd = new SqlCommand();
            cmd.Connection = con; //Kết nối cơ sở dữ liệu
            cmd.CommandText = sql; //Lệnh SQL
            try
            {
